...
<div style="padding-top: 105px; background-color: #8cd968;" class="categoryContainer">
    ...
    <span onclick="onClick('Seeds');" <?php if ($activeCat === "Seeds") echo 'class="active"' ?>>Seeds</span>
    <span onclick="onClick('Gifting');" <?php if ($activeCat === "Gifting") echo 'class="active"' ?>>Gifting</span>
</div>
